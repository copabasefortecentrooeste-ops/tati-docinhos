...
import { LayoutDashboard, Package, ShoppingBag, MapPin, Tag, Layers, Clock, Settings, LogOut, MessageCircle, MonitorPlay, Users } from 'lucide-react';
...
function AdminLayoutInner() {
  ...
  const navItems = [
    ...
    { path: `/${slug}/admin/clientes`, icon: Users, label: 'Clientes' },
